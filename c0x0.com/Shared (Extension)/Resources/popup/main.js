...
async function createAlias(domainScope, aliasName) {
  ...
  document.getElementById("maincontent").innerHTML = "<div class=\"card card text-white bg-info\"><div class=\"card-body\"><p class=\"card-text\">New alias created!</p></div></div>";
...
async function createForm(){
  ...
  document.getElementById("maincontent").innerHTML = "<h5>Create New Alias</h5><small>You are creating new alias." +
    ...
    "You can edit alias properties anytime at <a href=\"https://web.c0x0.com/shield/\">web.c0x0.com/shield/</a></small>";
...
function noAliasesDialog(){
  ...
  childElement.innerHTML = "<strong>No aliases found for this domain</strong><br>" +
    "<small>Aliases were not found but if alias for this domain already exist prior browser extension use - " +
    "you may attach it to this domain manually by visiting <a href=\"https://web.c0x0.com/shield/\" target=\"_blank\">web.c0x0.com/shield/</a></small>";
  ...
  if (aliases.result == "empty") {
      ...
      for (let alias of aliases) {
        ...
        if (alias.status == "inactive") {
           aliasStatus = "<sup class=\"text-warning\">This alias is disabled</sup><br>";
        }
...
async function preFlightCheck(){
  ...
  if (!jwtoken.jwt) {
    ...
    "<small>Looks like you just installed <a href=\"https://c0x0.com\" target=\"_blank\">c0x0.com</a> browser extension!<br>To configure extension you need to have active c0x0.com account.</strong></small>" +
